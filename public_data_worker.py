    ...
    while max_retries != 0:
        try:
            headers = {
                ...
                # 'cookie': f'mid=YJpPWAAEAAFQ7wlkijMo8albYEx0; ig_did={random.randrange(0,9)}BC3010{random.randrange(0,9)}-E3CA-4158-AECD-4A7EFDD6C15{random.randrange(0,9)}; ig_nrcb=1; csrftoken=dc7QeJJoWGmbla3oYwMXkDgsbnbrXwNm; ds_user_id=5874891389; sessionid=5874891389%3AChYJGmJzmvjdzz%3A9; shbid=10082; shbts=1621000731.854482; rur=ASH; csrftoken=iAyMcIur7tpPJyseuUZFemBGdtQ0iWcZ; ds_user_id=5874891389; ig_did=C7AC329F-8103-4888-B05E-A6220145846A; mid=YJpUpAAEAAERM14fCU_ieV4BLtQr; rur=ASH'
            }
...
while True:
    ...
    st = time.time()
    work = [i for i in db['users'].find({'public_data': False}, limit=1600)]
